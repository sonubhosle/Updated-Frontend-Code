...
const Navigation = () => {
  ...
  return (
    <div className="bg-white sticky top-0 z-index shadow-md">
      {/* Mobile menu */}
        ...
        <nav aria-label="Top" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div>
            <div className="flex h-16 items-center">
              ...
              {/* Logo */}
              <div className="ml-4 flex mr-9 lg:ml-0 ">
                 <a href='/' className='logo_name  flex items-center gap-1'><RiStoreLine />  D-Mart</a>
              </div>
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                ...
                                'relative z-10 -mb-px flex items-center border-b-2 pt-px text-[16px] font-medium transition-colors duration-200 ease-out'
                              )}
                            >
                              {category.name}
                            </Popover.Button>
                    ...
                    auth.user?.firstName ? (
                      <div>
                        <Avatar className='text-white'
                          ...
                          area-controls={open ? 'basic-menu' : undefined}
                          area-haspopup='true'
                      ...
                      <button onClick={handleOpen} className='text-sm font-medium ease-in rounded-sm transition bg-[#9155fd] text-white hover:bg-indigo-600 pl-3 pr-3 pt-2 pb-2'>
                        Login / Signup
                      </button>
                    )
                  }
